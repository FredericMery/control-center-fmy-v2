    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="sticky top-0 z-20 bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Historique des dépenses</h1>
            <p className="text-sm text-slate-600">Gérez vos dépenses</p>
          </div>
          <Link
            href="/expenses"
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600 mb-6">Aucune dépense pour le moment</p>
            <Link
              href="/expenses"
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-slate-600">
                      {expense.payment_method === 'cb_perso' ? 'CB Perso' : 'CB Pro'}
                    </p>
                  </div>
                </div>
              </div>
